...
#this script sets up the version of FreeSWITCH installed older isos
#it requires some manual work to find the hashtag.
...
##search fisheye.freeswitch.org for that commit "eg git-4936b11"
...
GITVER="4936b11cc85f94f42609f78d0bc27488ed522ff0"
