...
if (count($_POST)>0 && check_str($_POST["persistform"]) != "1") {
	...
	$sql = "insert into v_number_classes ";
	$sql .= "(";
	$sql .= "name, ";
	$sql .= "description, ";
	$sql .= "fee, ";
	...
	require_once "includes/header.php";
	echo "<meta http-equiv=\"refresh\" content=\"3;url=listclasses.php\">\n";
...
//show the content
	...
	echo "	<tr>\n";
	echo "		<td width='80%'>\n";
	echo "			<b>To add an inbound number class, please fill out this form completely. </b><br>";
	echo "		</td>\n";
