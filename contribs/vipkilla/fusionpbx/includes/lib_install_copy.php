...
//copy files from autoload_configs
	...
	$dst_dir = $v_conf_dir."/autoload_configs";	$tmp_file = 'lua.conf.xml'; if (!copy($src_dir.'/'.$tmp_file, $dst_dir.'/'.$tmp_file)) { echo "copy failed to $dst_dir<br />\n"; }
...
//get the script files
	...
	$tmp_file = 'fs_bind.lua'; if (!copy($src_dir.'/'.$tmp_file, $dst_dir.'/'.$tmp_file)) { echo "copy failed from ".$src_dir."/".$tmp_file." to ".$dst_dir."/".$tmp_file."<br />\n"; }
